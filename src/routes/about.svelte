...
<div class="sm:hidden flex flex-col  font-mono my-8">
    ...
    <img class='my-2' src="/images/profoak.jpg" alt="Professor Oak">
...
<div class="hidden sm:grid grid-cols-2 font-mono my-8">    
        <div>
            ...
            <p>If you want to see how I built this website using Svelte, TailwindCSS, some magic, and a lot of love, check out my <a class='font-bold underline hover:shadow-lg' href="https://github.com/btramel" target='none'>Github</a>.</p>
        </div>
        <div>
